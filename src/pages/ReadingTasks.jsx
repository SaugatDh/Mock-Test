...
const badgeStyles = [
  ...
  { bg: "bg-orange-50", ring: "ring-orange-200", icon: "text-orange-700" },
  { bg: "bg-fuchsia-50", ring: "ring-fuchsia-200", icon: "text-fuchsia-700" },
  { bg: "bg-pink-50", ring: "ring-pink-200", icon: "text-pink-700" },
];
    ...
    <Layout title="Reading">
      <Card className="border-slate-200 rounded-2xl p-5">
        <div className="flex items-center justify-between mb-4">
          <Badge className="bg-slate-900 text-white px-3 py-1.5 rounded-full hover:bg-slate-900">Mock Test</Badge>
        </div>
        ...
        <div className="flex gap-3 bg-sky-50 border border-sky-200 rounded-xl px-4 py-3 mb-5">
          ...
          <div>
            ...
            <p className="text-xs text-sky-700 mt-0.5">More high-quality reading tests will be added regularly.</p>
          </div>
        </div>
